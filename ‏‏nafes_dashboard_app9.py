...
st.title("لوحة تحليل بيانات المدارس (الإصدار النهائي)")
st.caption("تحليل نسب الأداء، التحسّن/الانخفاض، ترتيب المدرسة (إدارة/مملكة)، معالجة الأعمدة المكرّرة، واختيار وضع العرض الزمني، مع تنزيل كل النتائج في ملف Excel واحد يتضمن الجداول والرسوم.")
